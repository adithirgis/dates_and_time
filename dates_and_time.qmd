...
```{r}
# install.packages("lubridate") # install once and load later
library(tiduverse)
library(lubridate) 
```
...
Opens a new R document.
:::

## Cheatsheet of `lubridate`

[Click here.](https://rawgit.com/rstudio/cheatsheets/main/lubridate.pdf)
