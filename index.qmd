...
Read two files provided in the [link](https://drive.google.com/drive/folders/1azPWXaNOyhQB1js3Ne-xt_efFeWyuYnT) and name them as join_data_1 and join_data_2 accordingly. 
...
join_data_1 <- read_csv("join_data1.csv")
join_data_2 <- read_csv("join_data2.csv") 
```
